...
class StrategyTwo(inHour: Int, inMintue: Int, outHour: Int, outMintue: Int, rieki: Int, son: Int, hosei: Int, max: Int) {
  ...
  def params: String = {
    s"$IN_HOUR,$IN_MINTUE,$OUT_HOUR,$OUT_MINTUE,$RIEKI,$SON,$HOSEI,$MAX"
  }
